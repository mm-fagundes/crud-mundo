  ...
  <nav>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="/crud-mundo/web/pags/cadastros/cadastro-paises.php">Cadastro Países <span
          ...
          <li class="nav-item">
            <a class="nav-link" href="/crud-mundo/web/pags/gerenciar.php">Gerenciar</a>
          </li>
          <li class="nav-item">
